...
export default function Header({userInfo}) {
  ...
  return (
    <header className='flex justify-between backdrop-blur-3xl gap-1 font-bold items-center md:text-xl text-xs fixed z-[4] max-w-[1560px] py-2  md:px-9 w-[100%] '>
    ...
    <nav>
      <ul className='md:flex hidden gap-8 text-[#9606e3] items-center'>
